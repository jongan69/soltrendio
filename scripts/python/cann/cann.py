...
# Test the CANN Model
def test_cann(api_url, model_path, metadata_path, wallet_identifier):
    # Load metadata
    ...
    print(f"Testing on wallet: {wallet['address']}")

    for idx, holding in enumerate(wallet['topHoldings'][:max_tokens]):
...
if __name__ == "__main__":
    ...
    test_cann(API_URL, MODEL_PATH, METADATA_PATH, wallet_identifier)